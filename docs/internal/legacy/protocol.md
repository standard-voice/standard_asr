...
The output is a `TranscriptionResult` model (see `docs/internal/legacy/results.md`):
...
`standard_asr.features.FeatureFlag` (see `docs/internal/legacy/features.md`). Engines must
...
See `docs/content/specification/cli.md` and `docs/content/engine-authors/plugin-entry-points.md`.
