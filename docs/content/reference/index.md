...
For the engine-author surface (building a plugin), see [`standard_asr.engine`](./engine.md).

For inference-artifact status, acquisition, progress, and errors, see [Inference artifacts](./artifacts.md).
