...
- **Security by default.** Credentials are wrapped in `SecretStr`. URLs are validated (HTTPS, no server-side request forgery). Unsafe options require explicit opt-in.
